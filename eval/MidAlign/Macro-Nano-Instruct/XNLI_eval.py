"""
Zero-shot XNLI evaluation cho baseline MidAlign (LoRA) cua Macro-Nano-Instruct.

Khac voi eval/Macro-Nano-Instruct/XNLI_eval.py (danh gia thang base model)
va eval/finetuning/Macro-Nano-Instruct/XNLI_eval.py (danh gia baseline
...
Usage
-----
    python eval/MidAlign/Macro-Nano-Instruct/XNLI_eval.py \
