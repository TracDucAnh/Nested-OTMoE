...
def main():
    ...
    parser.add_argument("--lora_model_id", default="ducanhdinh/Qwen1.5-MoE-A2.7B-MidAlign",
    ...
    parser.add_argument("--output_dir", default="eval/MidAlign/Qwen1.5-MoE-A2.7B/results")
