"""
Zero-shot MMMLU (Multilingual MMLU) evaluation cho ban LoRA-finetuned cua
Macro-Nano-Instruct via log-likelihood scoring.
...
Usage
-----
    python eval/finetuning/Macro-Nano-Instruct/MMMLU_eval.py \
