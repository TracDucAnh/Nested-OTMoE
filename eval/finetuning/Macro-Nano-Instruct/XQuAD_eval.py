#!/usr/bin/env python3
"""
Zero-shot generative evaluation cua ban LoRA-finetuned cua Macro-Nano-Instruct
tren XQuAD.
...
file nay:
    ...
    3. Script nam sau hon 1 cap trong eval/finetuning/ so voi ban goc
       (eval/finetuning/Macro-Nano-Instruct/ thay vi eval/Macro-Nano-Instruct/),
       nen --data_root mac dinh can them 1 cap "../" de tro dung ve
       data/downstream/xquad tu project root.
...
Usage (run from eval/finetuning/Macro-Nano-Instruct/):
...
# ----------------------------------------------------------------------------- #
def main():
    parser = argparse.ArgumentParser(description="Zero-shot generative XQuAD eval cho LoRA-finetuned Macro-Nano-Instruct")
    parser.add_argument("--base_model_name_or_path", type=str, default="ATH-MaaS/Marco-Nano-Instruct")
    parser.add_argument("--lora_adapter_id", type=str, default="ducanhdinh/Macro-Nano-Instruct-Finetuning")
    ...
    parser.add_argument("--data_root", type=str, default="../../../data/downstream/xquad",
                         help="Path to data/downstream/xquad (tinh tu eval/finetuning/Macro-Nano-Instruct/)")
